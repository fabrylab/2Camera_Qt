...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowTitle('Basler two Camera') #window name

        ## botton icons and styling
        self.counter.setAlignment(QtCore.Qt.AlignCenter)
        self.rec.setIcon(QtGui.QIcon('rec.png'))
        self.stop.setIcon(QtGui.QIcon('stop.png'))
        self.live.setIcon(QtGui.QIcon('play.png'))
        self.mount.setIcon(QtGui.QIcon('mount.png'))
